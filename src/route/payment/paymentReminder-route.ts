...
import {
  ...
  paymentReminderResponseSchema,
  paymentRemindersResponseSchema,
  paymentReminderParamsSchema,
  paymentReminderParamsByInvoiceSchema,
} from '../../schemas/Payment/payment-reminder.schema'
  ...
  app.get(
    '/payment-reminder/:id',
    {
      schema: {
        ...
        params: paymentReminderParamsSchema,
        response: {
  ...
  app.get(
    '/payment-reminder/invoice/:invoiceId',
    {
      schema: {
        ...
        params: paymentReminderParamsByInvoiceSchema,
        response: {
          200: paymentRemindersResponseSchema,
        },
      },
    },
    async (request, reply) => {
